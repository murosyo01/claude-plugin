...
ソフトウェア設計・コードレビュー・セキュリティ・コードベース探索を支援する **Claude Code プラグイン集**です。  
個別に導入できます。
...
| **code-explorer** | LSPを活用したコードベース探索・依存関係マッピング | `code-explorer` | `code-explorer` | Sonnet |
